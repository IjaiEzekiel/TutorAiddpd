...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220309_tutoraid_789f3089110b0ab77301_20220309161759_archive.zip';
	const ARCHIVE_SIZE		 = '100461761';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '789f308-09161759';
    const SECONDARY_PACKAGE_HASH = 'fbe8114-09161759';
	const VERSION			 = '1.4.4';
